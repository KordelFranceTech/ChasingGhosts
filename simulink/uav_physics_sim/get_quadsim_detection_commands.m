function [WP_n, WP_e, h_c, psi_c] = get_quadsim_detection_commands(time)
% GET_QUADSIM_DETECTION_COMMANDS  Time-scheduled waypoint commands for detection mode.
%
% Variant of get_quadsim_trajectory_commands used when the UAV is operating
% in olfaction/detection mode. Swap the call in quadsim_control.m to use
% this function instead of get_quadsim_trajectory_commands.
%
% Outputs:
